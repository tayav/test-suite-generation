#############################################################################
# Makefile for building: mbc_tool
# Generated by qmake (3.0) (Qt 5.3.1)
# Project:  ../mbc_tool/mbc_tool.pro
# Template: app
# Command: /opt/Qt/5.3/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile ../mbc_tool/mbc_tool.pro
#############################################################################
...
INCPATH       = -I/opt/Qt/5.3/gcc_64/mkspecs/linux-g++ -I../mbc_tool -I/opt/Qt/5.3/gcc_64/include -I/opt/Qt/5.3/gcc_64/include/QtCore -I. -I.
LINK          = g++
...
SOURCES       = ../mbc_tool/main.cpp \
		../mbc_tool/boolean.cpp \
		../mbc_tool/fourier.cpp \
		../mbc_tool/specs.cpp 
OBJECTS       = main.o \
		boolean.o \
		fourier.o \
...
DIST          = /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../mbc_tool/mbc_tool.pro ../mbc_tool/main.cpp \
		../mbc_tool/boolean.cpp \
		../mbc_tool/fourier.cpp \
		../mbc_tool/specs.cpp
QMAKE_TARGET  = mbc_tool
...
Makefile: ../mbc_tool/mbc_tool.pro /opt/Qt/5.3/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt/5.3/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/shell-unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/5.3/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/Qt/5.3/gcc_64/mkspecs/features/yacc.prf \
		/opt/Qt/5.3/gcc_64/mkspecs/features/lex.prf \
		../mbc_tool/mbc_tool.pro \
		/opt/Qt/5.3/gcc_64/lib/libQt5Core.prl
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile ../mbc_tool/mbc_tool.pro
...
dist: 
	@test -d .tmp/mbc_tool1.0.0 || mkdir -p .tmp/mbc_tool1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/mbc_tool1.0.0/ && $(COPY_FILE) --parents ../mbc_tool/fourier.h ../mbc_tool/boolean.h .tmp/mbc_tool1.0.0/ && $(COPY_FILE) --parents ../mbc_tool/main.cpp ../mbc_tool/boolean.cpp ../mbc_tool/fourier.cpp ../mbc_tool/specs.cpp .tmp/mbc_tool1.0.0/ && (cd `dirname .tmp/mbc_tool1.0.0` && $(TAR) mbc_tool1.0.0.tar mbc_tool1.0.0 && $(COMPRESS) mbc_tool1.0.0.tar) && $(MOVE) `dirname .tmp/mbc_tool1.0.0`/mbc_tool1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mbc_tool1.0.0
...
main.o: ../mbc_tool/main.cpp /opt/Qt/5.3/gcc_64/include/QtCore/QCoreApplication \
		...
		../mbc_tool/fourier.h \
		../mbc_tool/boolean.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../mbc_tool/main.cpp

boolean.o: ../mbc_tool/boolean.cpp ../mbc_tool/boolean.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o boolean.o ../mbc_tool/boolean.cpp

fourier.o: ../mbc_tool/fourier.cpp ../mbc_tool/fourier.h \
		../mbc_tool/boolean.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o fourier.o ../mbc_tool/fourier.cpp

specs.o: ../mbc_tool/specs.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o specs.o ../mbc_tool/specs.cpp
